...
[Script]
WeTalk抓包 = type=http-request,pattern=^https:\/\/api\.wetalkapp\.com\/app\/queryBalanceAndBonus,script-path=WeTalk_Surge.js,requires-body=false
WeTalk签到 = type=cron,cronexp=20 8,20 * * *,script-path=WeTalk_Surge.js
...
// ── HTTP 请求：Surge 使用 $httpClient.get，回调转 Promise ───────────────────
